...
In vertebrates, they are metabotropic receptors, they belong to the family of g-protein coupled receptor (GPCR)~\cite{Buck1991,niimura2009evolutionary}. 
...
Using experimental paradigm like Luciferase Assay as used to study human olfactory systems \cite{mainland2015human}, 
may provide valuable complementary information to our simple model. human
...
so our model does not say anything about shape \cite{Keller2004,Araneda,uchida2000}, vibrational mode \cite{Turin,Franco2011,turin2015plausibility}, chirality \cite{tirandaz2015dissipative} or many other interesting properties of a molecule.
