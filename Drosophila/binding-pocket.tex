...
and predicted the volume and the structural flexibility of the binding-site of each receptor, 
...
In fact, the first term, $f_n(v)$, can be considered as the tuning curve of neuron $n$ with respect to the molecular volumes. 
...
\begin{figure}
		\centering
		\includegraphics[width= 0.85  \textwidth , angle=-90]{mean-std-vol-}
