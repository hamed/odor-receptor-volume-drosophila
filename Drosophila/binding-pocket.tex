...
we shuffle the association between rodorants and responses of a given OR $10^5$ times, 
an then check the null and alternative hypothesis. 
...
This problem can be addressed using another method -- False Discovery Rate (FDR)--  that keeps the rate of false positive below a threshold \cite{}.
