...
For example just puffing at the same dilution does not guarantee equal concentrations at the sensilla, because 
(a) some of the mists might directly hit the sensilla, 
(b) the concentration in air depends on the vapor pressure,
(c) The concentration in lymph depends water solubility of odorant, and  
(d) odorant binding-proteins may affect the process. 
To make the matter even more complicated, 
the effect of vapor pressure is not linear. 
Vapor pressure puts an upper limit on the concentration of the vapor of a liquid. 
If we are far from that concentration, 
then we can neglect the effect of vapor pressure, 
if we are close to that concentration, 
then the vapor pressure is very important. 
