...
\fdr of them were significant according to FDR correction (OR name in bold), 
and the rest (\nocorrection ORs), 
...
This work was done on the older version of DoOR database (DoOR 1.0). 
Recently, a newer version become available to the public that includes more data points (DoOR 2.0). 
The new data confirms our predictions. 
