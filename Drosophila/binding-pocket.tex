...
We perceive wavelength of light as its colors and frequency of sound as its pitch. But we don’t know yet what properties of a molecule are perceived as its smell. 
In this work, for the first time, we showed that molecular volume of an odorant is an important factor in the fruit fly. 
It affects two dimensions of smell: its intensity (weak or strong) and its quality (sweet, floral, fruity or etc). 
The molecular volume could describe the difference in the smell of methanol and butanol, two similar molecules of different sizes.  
Methanol smells pungent while butanol smells winy with a tad of banana like aroma.
...
that belong to the family of g-protein coupled receptor (GPCR)~\cite{Buck1991,niimura2009evolutionary}. 
But in insects their methods of signaling are under debate, 
they are ionotropic receptors which may also use metabotropic signaling in addition~\cite{Sato2008,Wicher2008,Nagel2011,Rong2011,yao2010}.
...
Size and flexibility of the binding-pocket have been used in the computational drug design as a predictor of binding-pocket for a given ligand~\cite{liang1998anatomy}. 

Here we focused on the volume and the flexibility of the binding-pocket.
...
included every other influential properties of molecules, 
...
\begin{figure*}
	...
	\caption{The preferred volumes of \numberofreceptors OR, $v_n$ (right). 
		...
		and the numbers in (\dots) show the percentage of DoOR 2.0 to the total data for each receptor.
		}
...
The flexibility of a receptor may affect the broadness of it tuning curve (Flexible receptor may bind to more odorants), 
...
suddenly Or82a became a perfect fit to our model with a Bonferroni corrected p-value of 0.03 (Fig. \ref{fig:Or82a}). 
This makes the underlying interaction between Geranyl acetate and Or82a, 
a special case that needs more investigations.
...
It is difficult to control them in the current experimental apparatus and the model will be very complex with many sets of parameters. 
For example, If we puff an odorant into the air, we will have a mixture of air, vapor and mist, 
...
because they evaporate easily and solve in water well and they might not need the help of odorant binding proteins, 
