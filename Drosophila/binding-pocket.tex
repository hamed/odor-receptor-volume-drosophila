...
\begin{figure}
	\centering
	\includegraphics[width=0.5 \textwidth]{binding-pocket-size-flex}
	\caption{This figure shows different scenarios that may happen when an odorant molecule (ligand) binds to a receptor. 
		...
		(button) The flexibility of a receptor may compensate for the volume mismatches.
		}
...
%	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=  0.85 \textwidth]{mean-vol}
		\includegraphics[width=  0.85 \textwidth]{std-vol}
%	\end{subfigure}
...
% do not touch this fig.
	\centering
	\includegraphics[width= 0.5 \textwidth]{pair-pval}
