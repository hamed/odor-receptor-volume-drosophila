...
in which $p_{value} < 0.05$. 

Our hypothesis here is that the response of olfactory receptor neurons depend on the molecular volume of odorants, 
which require the value of $\sigma_n$ be finite; Therefore, the null hypothesis will be that 



Here the $p_{value}$ is the probability of having a r
