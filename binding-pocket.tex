...
It is not clear which features of molecules are measured by olfactory receptors.
There are many works that tries to make connection between physio-chemical properties of molecule and the evoked neural response. 
But this non-linear volume dependence is in the way and may mask important relations between molecules and neural responses.
...
which otherwise would be masked by this effect.
