...
%	\end{subfigure}
	\caption{Response of \numberofreceptors olfactory receptors  versus molecular volume of odorants (circles),  
		...
		12 of them (receptor names in bold) has a p-value of less than 0.05/49 (Bonferroni correction), 
		one of them (receptor name in italic) has a p-value of less than 0.05,
...
\begin{figure}
	\begin{subfigure}[b]{\textwidth}
		...
		Some receptors prefer smaller molecules - like Or59b, Or67b and  Or85a, 
		but some other receptors prefer larger molecules - like  Or85c,  Or1a and  Or49a.}
	...
	\begin{subfigure}[b]{\textwidth}
		...
		\caption{The flexibility of each receptor ($\sigma_n$), the error bars are calculated using Jack-Knife method.
			...
			but some other receptors like Or22a,  Or67b and  Or33a show flexibility and respond to broader range of molecular volumes.
		}
