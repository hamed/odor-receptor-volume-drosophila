...
any change in the molecular volume would produce a change only in intensity of smell (assuming every other characteristic of the molecule remain the same).
...
That may describe why XX smells XXX  and XX smells XX, only their molecular volumes are different.
