...
We know that an olfactory receptor can be triggered by different odorant molecules, 
and an odorant molecule can excite many different receptor types; 
It is a combinatorial code.
However, the exact mechanism of odorant interaction with receptors is not known, 
it is not clear that which properties of a molecule affects its smell and it is the topic of ongoing researches.

There are many studies that tries to make connection between physiochemical properties of molecules and their perceived odors, 
and there are also many theories available, for example, shape theory and vibrational theory, yet we are far from understanding the olfactory system, 
because the problem is hard and complex. 

The problem is difficult to study because of three reasons. 
hundreds to thousands olfactory receptors are involved (Drosop, 
there are many odorants molecules,
