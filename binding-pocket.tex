...
If we use a simple threshold of 0.05 for the p-values, we may have false positives. 
...
The result are labelled accordingly in Fig.\ref{fig:vol-res:all}.
...
\begin{figure}
	...
	\caption{The binding-pocket's volume and flexibility in olfactory receptors are divers.
		The upper triangle shows pairs of olfactory receptors that differ in the binding-pocket's volume,
		The lower triangle shows pairs that differ in the binding-pocket's flexibility.
		The darkness of the shades show the level of significance:
		Whites are insignificant differences, 
		all the shades of blue have a p-value of less than 0.05,
		darker shades are significant considering FDR correction, 
		and the darkest shade are significant according to Bonferroni correction.
		}
\end{figure}
