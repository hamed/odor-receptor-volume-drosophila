...
\end{figure}•
In this section, we introduce the format of neural data, 
the source of molecular volumes, 
and the mathematical method of calculating the size and flexibility of binding-pocket from the neural data.
