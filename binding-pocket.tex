...
%\centering
	...
	\caption{The DoOR database includes 240 odorant molecules.
			Each receptor has been excited with only a subset of them (blue shade, dark gray in b\&w print);
			Therefore, there are missing data (pink shade, light gray in b\&w print).}
