...
encodes the results and transmit them to limbic system and olfactory cortex.
...
That makes the olfactory bulb (or antennal lobe in insects) the best place to study effect of odorant molecules on the olfactory receptors. 
...
Linda B. Buck and Richard Axel won the Nobel Prize in Physiology or Medicine, in 2004, for this discovery.
Scientist believed that the same kind of signal transduction is present in insect as well, 
but recently, some work showed that the olfactory receptors in insect may be inotropic. 

Regardless of the signal transduction, 
all olfactory receptor have the same function.
Ligands (odorants) bind to them, activate them and then they send the signal to the cell in one way or another. 

To activate a receptor, first an odorant must meet the geometrical constraints of the receptor: 
The size of the odorant molecule should match the dimensions of the binding pocket of the receptor,
this will affects the quality of the binding which in turn affects the neural response. 
%%
