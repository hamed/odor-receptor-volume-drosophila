...
in which the relative error of $v_n$ is lesser than 25\% and $\sigma_n < 80 \AA$, 
...
\begin{figure}
	...
	\caption{Response of olfactory receptors  versus molecular volume of odorants (Circles), the fitted functions $f_n(v)$ from Eq. 			\ref{eqn:factors} (solid lines), 
		...
		for all \numberofreceptors receptors in which the relative error is lesser than 25\% (Fig.~\ref{fig:vol-res:all}) and for one selected receptor Or35a (Fig.~\ref{fig:vol-res:one}) just to magnify details. }
	\label{fig:vol-res}
\end{figure}
\begin{figure}
	\begin{subfigure}[b]{\textwidth}
