...
in which the relative error of $v_n$ is lesser than 25\% and $\sigma_n < 80 \AA^3$, 
...
\begin{figure}
	\begin{subfigure}[b]{\textwidth}
		...
		Some receptors prefer smaller molecules - like {\it Or59b}, {\it Or67b} and {\it Or85a}, 
		but some other receptors prefer larger molecules - like {\it Or85c}, {\it Or1a} and {\it Or49a}.}
	...
	\begin{subfigure}[b]{\textwidth}
		...
		\caption{The flexibility of each receptor ($\sigma_n$), the error bars are calculated using Jack-Knife method.
			Some receptors like {\it Or46a}, {\it Or71a} and {\it Or22b} are volume  selective, 
			but some other receptors like {\it Or22a},  {\it Or67b} and {\it Or33a} show flexibility and respond to broader range of molecular volumes.
		}
