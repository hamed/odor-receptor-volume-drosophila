...
%	\end{subfigure}
	\caption{Response of olfactory receptors  versus molecular volume of odorants (circles),  
			...
			Among them, \fdr have FDR corrected p-value $<0.05$ (receptor names in bold or normal) and 
			\bonferroni have a Bonferroni corrected p-value $<0.05$ (receptor names in bold).
		}
	\label{fig:vol-res}
\end{figure}
