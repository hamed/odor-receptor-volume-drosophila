...
so that each glomerulus of olfactory bulb receives an amplified signal from only one type of olfactory receptor.~\cite{Couto2005a}
...
it is a topic of ongoing researches and there are many theories~\cite{Turin,Keller2004a,Araneda2000,Brookes2007,Franco2011,Pelz2006,Gabler2013,Schmuker2007}.
...
but recently, Sato and Wicher argued that the olfactory receptors in insects are inotropic~\cite{Sato2008,Wicher2008}. 
...
using various methods like Molecular Dynamic (MD) simulations,
 mutagenesis studies, heterologus expression studies, and homology modeling~\cite{Khafizov2007,Man2004,Lai2005c,Vaidehi2002,Floriano2004c,Schmiedeberg2007b,Katada2005a,Kato2008b}.
