...
for the discovery of this and some of the above facts~\cite{}.
There are many similarities between the olfactory system of insects and vertebrates~\cite{}.
...
using various methods like Molecular Dynamic (MD) simulations~\cite{}, 
...
that includes the neural responses of most olfactory receptors (OR) of Drosophila to many odorants~\cite{}. 
...
We take the neural data of DoOR database \cite{} and we calculate molecular volume using a computational chemistry software -- VEGA ZZ~\cite{}. 
...
\begin{figure}
	...
	\includegraphics[width=0.75 \textwidth]{fig/vol-res-Or43a}
	...
	for all \numberofreceptors receptors (top) and for one selected receptor Or43a(bottom) to demonstrate the details. }
	\label{fig:vol-res}
\end{figure}•
\begin{figure}
...
and there are many works that tries to connect the physio-chemical properties of molecules to the evoked neural response or perceived smells~\cite{}.
