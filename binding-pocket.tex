...
\begin{abstract}
	...
	%and after that, we infer some structural properties of the binding-pocket of olfactory receptors.
        Which properties of an odorant do determine the intensity and quality of its smell?
	...
	The effect is considerable and non-linear;   
	It can mask any other underlying relations between properties of molecules and neural responses;
	there for this effect should be considered in further experimental or theoretical studies.
