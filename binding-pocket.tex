...
\caption{Response of 28 odor-receptors  versus molecular volume of odorants (Circles), and the fitted functions $f_n(v)$ from Eq. \ref{eqn:factors} (solid lines).}
\label{fig:vol-res}
\end{figure}•

\begin{figure}
\includegraphics[width=\textwidth]{fig/mean-vol}
\caption{The prefered volumes of 28 receptors, and their error bars. Error bars are calculated using Jack-Knife method. 
...
\caption{The selectivity of receptors.}
\end{figure}•
