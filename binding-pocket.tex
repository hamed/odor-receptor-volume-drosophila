...
\begin{figure}
	...
	\caption{The binding-pocket's volume and flexibility in olfactory receptors are divers.
		...
		the lower triangle shows the pairs that differ in the binding-pocket's flexibility.
		The darkness shows significance level:
		White is insignificant, 
		all the shades of blue are significant with p-value of less than 0.05,
		two darker shades are significant considering FDR correction, 
		and the darkest shade is significant according to Bonferroni correction.
		}
\end{figure}
