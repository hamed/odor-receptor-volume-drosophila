...
\headerbox{The assumptions}{name=assumptions,column=0,below=abstract}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{The materials}{name=materials,column=0,below=assumptions}{

Majid:
DoORs log, Vega zz logo.
...
\headerbox{The methods}{name=methods,column=1,row=0}{
\small
...
\headerbox{results and discussions}{name=results and discussions,column=2,span=1,row=0}{
...
\begin{center}
		\includegraphics[width=  0.75 \textwidth]{fig/mean-vol}
\end{center}

\begin{center}
		\includegraphics[width=  0.75 \textwidth]{fig/std-vol}
\end{center}


\begin{center}
\includegraphics[width= \textwidth]{fig/pair-pval}
\end{center}
