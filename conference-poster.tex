...
\documentclass[a1paper,fontscale=0.5956]{baposter} % Adjust the font scale/size here
...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=4em]{fig/logo.jpg}} % First university/lab logo on the left
...
{\includegraphics[height=4em]{fig/logo.jpg}} % First university/lab logo on the 
...
%\bibliography{sample} % Use sample.bib as the bibliography file
 \begin{thebibliography}{1}
  ...
  \bibitem{saberi} Majid Saberi, Hamed Seyed-allaei, {\em Olfactory receptors of Drosophila are sensitive to molecular volume of odorants.}, 2015, bioRxiv, DOI:http://dx.doi.org/10.1101/013516 
...
\headerbox{Contact Information}{name=contact,column=1,above=bottom}{ % This block is as tall as the references block
...
\begin{center}
\includegraphics[width=0.75 \textwidth]{fig/binding-pocket} \\
\end{center}
...
\headerbox{Materials}{name=materials,column=0,below=assumptions,above=references}{
...
\begin{center}
\includegraphics[width=0.15 \textwidth]{fig/DoOR-logo}
\hspace{10mm}
\includegraphics[height=0.15 \textwidth]{fig/VEGAZZ-logo}
\end{center}
...
\headerbox{Methods}{name=methods,column=1,row=0, bottomaligned=assumptions}{
\small
...
\headerbox{Tests}{name=tests,column=1,below=methods,above=contact}{
...
\begin{center}
		\includegraphics[width= 0.9 \textwidth]{fig/vol-res-}
\end{center}
