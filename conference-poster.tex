...
{\includegraphics[height=4em]{logo.jpg}} % First university/lab logo on the 
...
\headerbox{introduction}{name=method,column=0,below=objectives}{ % This block's bottom aligns with the bottom of the conclusion block
